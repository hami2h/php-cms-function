                ...
                foreach ($listmenu as $list):
                    ...
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td>
                            <a href="dashboard.php?m=testimonial&p=edit&id=<?php echo $list['id']; ?>">
                                <button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button>
                            </a>
                            <a href="dashboard.php?m=testimonial&p=delete&id=<?php echo $list['id']; ?>">
