...
if ($_GET['id']) {
    $id = $_GET['id'];
    $result = selecttestimonialadmin($id);
}
if (isset($_POST['btn'])) {
    $data = $_POST['frm'];
    $file = $_FILES['file'];
    edittestimonialadmin($data, $id, $file);
}
?>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form role="form" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>متن نظر</label>
                        <input value="<?php echo $result['about']; ?>" type="text" class="form-control"
                               name="frm[about]" placeholder="عنوان منو را وارد کنید">
                    </div>
                    <div class="radio">
                        <label>
