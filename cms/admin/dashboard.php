        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=post&p=list">لیست نوشته ها</a></li>
                        <li><a class="" href="dashboard.php?m=post&p=add">افزودن نوشته جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=service&p=list">لیست سرویس ها</a></li>
                        <li><a class="" href="dashboard.php?m=service&p=add">افزودن منو جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=property&p=list">لیست ویژگی ها</a></li>
                        <li><a class="" href="dashboard.php?m=property&p=add">افزودن ویژگی جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=team&p=list">لیست اعضا</a></li>
                        <li><a class="" href="dashboard.php?m=team&p=add">افزودن عضو جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=project&p=list">لیست پروژه ها</a></li>
                        <li><a class="" href="dashboard.php?m=project&p=add">افزودن پروژه جدید</a></li>
                        <li><a class="" href="dashboard.php?m=project&p=addcat">افزودن دسته بندی جدید</a></li>
                        <li><a class="" href="dashboard.php?m=project&p=listcat">لیست دسته بندی</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=testimonial&p=list">لیست نظرات</a></li>
                        <li><a class="" href="dashboard.php?m=testimonial&p=add">افزودن نظر جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="dashboard.php?m=setting&p=list">مدیریت تنظیمات</a></li>
                    </ul>
                </li>
